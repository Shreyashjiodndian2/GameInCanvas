...
var modelEl = document.getElementById('model-el');
...
var Player = /*#__PURE__*/function (_Object2) {
  ...
  function Player(x, y, radius, color) {
    ...
    return _super.call(this, x, y, radius, color);
  }
...
var Projectile = /*#__PURE__*/function (_Object3) {
  _inherits(Projectile, _Object3);

  var _super2 = _createSuper(Projectile);
  ...
  function Projectile(x, y, radius, color, velocity) {
    ...
    _this = _super2.call(this, x, y, radius, color);
    _this.velocity = velocity;
    _this.angle = Math.atan2(mouse.y - center.y, mouse.x - center.x);
    return _this;
  }
  ...
  _createClass(Projectile, [{
    key: "draw",
    value: function draw() {
      _get(_getPrototypeOf(Projectile.prototype), "draw", this).call(this);
    }
  }, {
    key: "update",
    value: function update() {
...
var Enemy = /*#__PURE__*/function (_Object4) {
  _inherits(Enemy, _Object4);
  ...
  function Enemy(x, y, radius, color, velocity) {
    ...
    _this2 = _super3.call(this, x, y, radius, color);
    _this2.velocity = velocity;
    _this2.angle = Math.atan2(center.y - _this2.y, center.x - _this2.x);
    return _this2;
  }
...
var Particle = /*#__PURE__*/function (_Object5) {
  _inherits(Particle, _Object5);

  var _super4 = _createSuper(Particle);
  ...
  function Particle(x, y, radius, color, velocity) {
    ...
    _this3 = _super4.call(this, x, y, radius, color);
    _this3.ttl = 100;
    _this3.velocity = velocity;
    _this3.alpha = 1;
    return _this3;
  }
...
function spawnEnemies() {
  ...
  var x = Math.random() < 0.5 ? canvas.width : 0;
  var y = Math.random() * canvas.height;
  var radius = Math.random() * (30 - 4) + 4;
  var color = "hsl(".concat(Math.random() * 360, ", 100%, 50%)");
  var velocity = Math.random() * 1 + 1;
  enemies.push(new Enemy(x, y, radius, color, velocity));
}

var player = new Player(center.x, center.y, 10, '#FFF');
player.draw();
...
function animate() {
  ...
  enemies.forEach(function (enemy) {
    enemy.update();
    var distFromPlayer = Math.hypot(enemy.x - player.x, enemy.y - player.y);
    ...
    projectiles.forEach(function (projectile) {
      var distance = Math.hypot(enemy.x - projectile.x, enemy.y - projectile.y);
